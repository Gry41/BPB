...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { description: @tour.description, facilities: @tour.facilities, name: @tour.name, price: @tour.price, time: @tour.time } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { description: @tour.description, facilities: @tour.facilities, name: @tour.name, price: @tour.price, time: @tour.time } }
