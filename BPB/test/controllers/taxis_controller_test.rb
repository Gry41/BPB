...
class TaxisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taxi" do
    assert_difference('Taxi.count') do
      post taxis_url, params: { taxi: { driver_name: @taxi.driver_name, places: @taxi.places } }
    end
  ...
  test "should update taxi" do
    patch taxi_url(@taxi), params: { taxi: { driver_name: @taxi.driver_name, places: @taxi.places } }
